    ...
    view.innerHTML = `
        <div class="p-4 md:p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
                <div class="bg-gradient-to-br from-orange-400 to-orange-500 rounded-xl shadow-lg p-4 md:p-6 text-white">
                    <div class="text-xs md:text-sm opacity-90 mb-1 md:mb-2">خارج المبنى</div>
                    <div class="text-2xl md:text-4xl font-black">${globalStats.outdoor_queue || 0}</div>
                    <div class="text-xs opacity-75 mt-1 md:mt-2">المستهدف: ${globalStats.daily_target}</div>
                    <div class="text-xs opacity-75">${targetProgress}% من الهدف</div>
                </div>
                
                <div class="bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl shadow-lg p-4 md:p-6 text-white">
                    <div class="text-xs md:text-sm opacity-90 mb-1 md:mb-2">داخل المبنى</div>
                    <div class="text-2xl md:text-4xl font-black">${totalInside}</div>
                    <div class="text-xs opacity-75 mt-1 md:mt-2">انتظار: ${totalWaiting}</div>
                    <div class="text-xs opacity-75">مقابلات: ${totalInterview}</div>
                </div>
                
                <div class="bg-gradient-to-br from-purple-400 to-purple-500 rounded-xl shadow-lg p-4 md:p-6 text-white">
                    <div class="text-xs md:text-sm opacity-90 mb-1 md:mb-2">الطاقة المتبقية</div>
                    <div class="text-2xl md:text-4xl font-black">${remainingCapacity}</div>
                    <div class="text-xs opacity-75 mt-1 md:mt-2">من ${totalCapacity}</div>
                </div>
                
                <div class="bg-gradient-to-br from-green-400 to-green-500 rounded-xl shadow-lg p-4 md:p-6 text-white">
                    <div class="text-xs md:text-sm opacity-90 mb-1 md:mb-2">تمت خدمتهم</div>
                    <div class="text-2xl md:text-4xl font-black">${globalStats.served_count || 0}</div>
                </div>
            </div>
